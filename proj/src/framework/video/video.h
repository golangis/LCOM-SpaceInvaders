...
#include "xpm/replay-button.xpm"
#include "xpm/menu-button.xpm"
...
xpm_image_t replay_button_img;
xpm_image_t menu_button_img;
...
uint8_t* replay_button_map;
uint8_t* menu_button_map;
